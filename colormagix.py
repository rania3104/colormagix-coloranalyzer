...
analyze_button = tk.Button(right_frame, text="Upload Image", command=analyze_image, font=("Helvetica", 14, "bold"), bg="#FFA500", fg="#000000", activebackground="#FFD700", activeforeground="#000000")
